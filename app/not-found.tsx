...
export default function NotFound() {
  return (
    ...
    >
      ...
      <Link
        href="/"
        className="relative inline-block mt-6 px-7 py-[10px] text-[13px] tracking-[0.14em] uppercase text-[#E2E2E2] no-underline transition-colors duration-[250ms] hover:text-white cursor-pointer"
      >
