  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="flex gap-0">
        <div className="flex items-center gap-2 px-3 bg-[#111] border border-r-0 border-[#303030] shrink-0">
        ...
        <input
          ...
          className="flex-1 bg-[#111] border border-[#303030] px-3 py-3.5 text-base text-[#f1f1f1] placeholder:text-[#747474] font-figtree tracking-tight focus:outline-none focus:border-[#474747] transition-colors disabled:opacity-50 min-w-0"
        />
      </div>
    </div>
  );
