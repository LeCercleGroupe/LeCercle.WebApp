    ...
    >
      ...
      <div className="relative flex flex-col flex-1 min-h-170 pt-10 pb-8 px-5 bg-[url('/images/invite.png')] bg-cover bg-center border-3 border-(--card-color) overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col flex-1 items-center text-center">
          ...
          <Link
            href={pkg.cta.href}
            className="group relative w-2/3 sm:w-full py-3 font-figtree text-[10px] tracking-widest uppercase text-(--card-color) bg-(--card-color)/10 hover:bg-(--card-color)/30 transition-all duration-200 cursor-pointer"
          >
