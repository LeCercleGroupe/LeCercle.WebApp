      ...
      <div className="relative w-[80%] max-w-2xl text-center">
        ...
        {screen.cta && (
          <Link
            ...
            className="mt-8 inline-flex items-center justify-center px-7 py-3 text-[11px] tracking-[0.16em] uppercase text-white/70 hover:text-white bg-white/10 hover:bg-white/30 font-figtree relative transition-all duration-250 group cursor-pointer"
          >
            <span className="absolute top-0 left-0 w-3.5 h-2.5 border-t border-l border-white/70" />
            <span className="absolute top-0 right-0 w-3.5 h-2.5 border-t border-r border-white/70" />
            <span className="absolute bottom-0 left-0 w-3.5 h-2.5 border-b border-l border-white/70" />
            <span className="absolute bottom-0 right-0 w-3.5 h-2.5 border-b border-r border-white/70" />
            {screen.cta.label}
          </Link>
        )}
      </div>
